...
if ($admin_logged_in == true) {
    ...
    <script type = "text/javascript" src = "<?php echo base_url() ?>resources/admin/js/nicedit/nicEdit.js"></script>
        ...
        if (window.self === window.top) {
            ...
            bkLib.onDomLoaded(function() {
                myNicEditor = new nicEditor({
                    iconsPath: '<?php echo base_url() ?>resources/admin/js/nicedit/nicEditorIcons.gif',
                    fullPanel: true,
